...
setup(
    ...
    url='https://github.com/collective/cusy.cms',
    project_urls={
        'PyPI': 'https://pypi.python.org/pypi/cusy.cms',
        'Source': 'https://github.com/collective/cusy.cms',
        'Tracker': 'https://github.com/collective/cusy.cms/issues',
    ...
    target = plone
    [console_scripts]
    update_locale = cusy.cms.locales.update:update_locale
    """,
)
