...
class EventIntegrationTest(unittest.TestCase):
    """Validate the Event content type."""
    ...
    def tearDown(self):
        ...
        if "event" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="event")  # noqa: P001
        if "event-1" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="event-1")  # noqa: P001
    ...
    def test_default_view(self):
        ...
        self.assertEqual("event_view", self.fti.default_view)
