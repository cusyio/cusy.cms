...
class ImageIntegrationTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if "image" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="image")  # noqa: P001
        if "image-1" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="image-1")  # noqa: P001
    ...
    def test_behaviors(self):
        ...
        self.assertTrue(len(self.fti.behaviors) >= 0)
    ...
    def test_default_view(self):
        ...
        self.assertEqual("image_view", self.fti.default_view)
