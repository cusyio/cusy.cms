...
class LinkIntegrationTest(unittest.TestCase):
    """Validate the Link content type."""
    ...
    def tearDown(self):
        ...
        if "link" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="link")  # noqa: P001
        if "link-1" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="link-1")  # noqa: P001
    ...
    def test_view_methods(self):
        ...
        for item in ["link_redirect_view"]:
    ...
    def test_default_view(self):
        ...
        self.assertEqual("link_redirect_view", self.fti.default_view)
