# -*- coding: utf-8 -*-
"""Content type tests for News Item."""
...
class NewsItemIntegrationTest(unittest.TestCase):
    """Validate the News Item content type."""
    ...
    def tearDown(self):
        ...
        if "news-item" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="news-item")  # noqa: P001
        if "news-item-1" in self.portal.objectIds():
            self.portal.manage_delObjects(ids="news-item-1")  # noqa: P001
    ...
    def test_default_view(self):
        ...
        self.assertEqual("newsitem_view", self.fti.default_view)
